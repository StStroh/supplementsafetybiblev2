        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-xl p-8 text-center text-white shadow-lg">
            <h3 className="text-2xl font-bold mb-3">
              Check your full supplement and medication list
            </h3>
            <p className="text-emerald-50 mb-6 max-w-2xl mx-auto">
              Get a comprehensive interaction analysis of all your supplements and medications in seconds.
            </p>
            <Link
              to="/check"
            ...
            >
              <span>Run a full interaction check</span>
