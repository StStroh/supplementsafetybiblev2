...
const gold = [
  ...
  [sjw,'Sertraline (Zoloft)','severe','Risk of serotonin syndrome; CYP inducer reduces drug levels','Do not combine; consult prescriber immediately. Not medical advice.'],
...
const lowPairs = [
  ...
  {sups:['Probiotics','Prebiotics'],meds:['Metformin','Atorvastatin','Simvastatin','Pravastatin','Rosuvastatin','Lisinopril']},
  {sups:['CoQ10','Coenzyme Q10 (CoQ10)'],meds:['Metoprolol','Lisinopril','Losartan','Amlodipine','Diltiazem']},
  ...
  {sups:['Omega-3','Fish Oil','Fish Oil (Omega-3)'],meds:['Atorvastatin','Simvastatin','Pravastatin','Rosuvastatin']},
  {sups:['Turmeric','Curcumin','Turmeric (Curcumin)'],meds:['Metformin','Atorvastatin','Lisinopril']},
...
const safeSups = SUPS.filter(s=>![sjw,'Ginkgo Biloba','Garlic','Vitamin K','Vitamin K2','Fish Oil','Omega-3','Fish Oil (Omega-3)','5-HTP','Niacin','Potassium'].includes(s));
const safeMeds = MEDS.filter(m=>!['Warfarin','Sertraline','Sertraline (Zoloft)','Fluoxetine','Escitalopram','Digoxin','Levothyroxine','Ciprofloxacin','Levofloxacin','Doxycycline','Insulin','Spironolactone'].includes(m));
